...
# Die Integrationstests laufen gegen "test", nicht gegen "app": sie legen
# Tabellen an und loeschen sie wieder.
...
async def client() -> AsyncIterator[AsyncClient]:
    ...
    app = create_service(settings, module=register_aus([artefakt]))
